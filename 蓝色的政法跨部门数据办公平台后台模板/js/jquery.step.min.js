!function (i) {
    i.fn.step = function (e) {
        var t = this, n = {
            ...
            time: 400,
            title: []
        }, s = (e = i.extend({}, n, e)).title, d = s.length, u = e.time, p = (t.width()-30) / d;
        t.index = e.index;
        var a = function () {
            var e = "";
            s.length > 0 && (e += '<div class="ui-step-wrap"><div class="ui-step-bg"></div><div class="ui-step-progress"></div><ul class="ui-step">', i.each(s, function (i, t) {
                e += '<li class="ui-step-item">' +
                    '<div class="ui-step-item-num"><span class="glyphicon glyphicon-ok-circle">'+ "</span></div>" +
                    '<div class="ui-step-item-title">' + t + '</div>' +
                    "</li>"
